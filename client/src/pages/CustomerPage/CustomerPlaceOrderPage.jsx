...
//                         <div 
//                             key={status} 
//                             className={`status ${status.toLowerCase().replace(/\s+/g, '')} ${getStatusClassCustomer(`is${status}`, order) === `is${status}` ? 'active' : ''}`}
//                         >
//                             <div className={`status-circle ${getStatusClassCustomer(`is${status}`, order) === `is${status}` ? 'active' : ''}`}></div>
//                             <p>{status}</p>
